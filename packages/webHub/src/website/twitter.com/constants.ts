...
export const consumerSecret = 'Bcs59EFbbsdF6Sl9Ng71smgStWEGwXXKSjYvPVt7qys'

export const graphQLEndpointsPlain = [
...
export const gqlMap = Object.fromEntries(graphQLEndpointsPlain.map(endpoint => [endpoint.split('/')[3].replace(/V2$|Query$|QueryV2$/, ''), endpoint]))
