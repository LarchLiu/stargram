...
describe('utils', () => {
  test('get domain', async () => {
    ...
    expect(res).toBe(host)
    res = getDomain('github.com')
    expect(res).toBe(host)
    res = getDomain('https://github.com/LarchLiu')
    expect(res).toBe(host)
    res = getDomain('http://github.com/LarchLiu')
    expect(res).toBe(host)
    res = getDomain('github.com/LarchLiu')
    expect(res).toBe(host)
    res = getDomain('https://gist.github.com/LarchLiu')
    expect(res).toBe(host)
    res = getDomain('http://gist.github.com/LarchLiu')
    expect(res).toBe(host)
  ...
  test('preprocess text', async () => {
    ...
    `
    const countBefore = countWord(text)
    expect(countBefore).toMatchSnapshot()
    const lengthBefore = text.length
    expect(lengthBefore).toMatchSnapshot()
