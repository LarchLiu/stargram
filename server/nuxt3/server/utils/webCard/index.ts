import type { GithubRepoMeta, TwitterTweetMeta, WebCardData, WebInfoData } from '@starnexus/core'
...
export async function createWebCard(webInfo: WebInfoData): Promise<WebCardData> {
  try {
