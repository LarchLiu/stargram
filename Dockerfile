...
ARG VITE_TWITTER_OAUTH_TOKEN
ENV VITE_TWITTER_OAUTH_TOKEN=$VITE_TWITTER_OAUTH_TOKEN

ARG VITE_TWITTER_OAUTH_TOKEN_SECRET
ENV VITE_TWITTER_OAUTH_TOKEN_SECRET=$VITE_TWITTER_OAUTH_TOKEN_SECRET
